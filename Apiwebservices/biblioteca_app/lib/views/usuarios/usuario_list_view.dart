...
class _UsuarioListViewState extends State<UsuarioListView> {
  ...
  List<UsuarioModel> _usuarios = []; //lista para guardar os usuário
  bool _carregando = true; //bool para usar no view

  @override
  void initState(){ //carregar os dados antes da construção da tela 
    super.initState();
  ...
  _load() async{
    ...
    try{
      _usuarios = await _controller.fetchAll(); //preencher a lista de usuário com os usuário do DB
  ...
  void _filtrar(){//filtrar da lista já carregada
