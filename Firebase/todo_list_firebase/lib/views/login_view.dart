  ...
  void _login() async{
    try {
      await _auth.signInWithEmailAndPassword(
        ...
        //AuthWidget -> Direcionar para a tela interna automaticamente
      );
    } on FirebaseAuthException catch (e) { //tratar erro mais específico
    //tratar erro
          ...
          children: [
            ...
            TextField(
              ...
              decoration: InputDecoration(
                ...
                obscureText: _invisivel, //ocultar os caracteres da senha
