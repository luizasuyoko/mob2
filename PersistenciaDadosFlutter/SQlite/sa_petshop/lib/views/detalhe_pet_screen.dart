//construit a janela de detalhe do pet
...
class _DetalhePetScreenState extends State<DetalhePetScreen>{
  //info do pet
  //info da consulta do pet
  final _petControl = PetControlller();
  ...
  //carregar as infos no initstate
  @override
  void initState() {
    super.initState();
    _carregarDados();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () async{
          await Navigator.push(context, MaterialPageRoute(builder: (context)=> CriarConsultaScreen(petId: widget.petId)));
          _carregarDados();
        },
