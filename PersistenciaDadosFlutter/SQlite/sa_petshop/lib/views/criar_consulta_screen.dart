//tela para criar servico para o pet
...
class _CriarConsultaScreenState extends State<CriarConsultaScreen>{
  ...
  DateTime _selectedDate = DateTime.now(); //nao pode selecionar uma data anterior a data atual
  TimeOfDay _selectedTime = TimeOfDay.now(); //nao pode selecionar uma hora anterior a hoara atual

  //método para selecao de data
  ...
  void _salvarConsulta() async {
    if(_formKey.currentState!.validate()){
      _formKey.currentState!.save(); //salva os valores do formulario
      ...
      try {
        await _consultaControl.createConsulta(newConsulta);
    ...
    return Scaffold(
      ...
      child: Form(
        child: ListView(
          children: [
            TextFormField(
              decoration: InputDecoration(labelText: "Tipo de Servico"),
            ...
            Row(
              children: [
                Expanded(child: Text("Data: ${horaFormatada.format(DateTime(0,0,0,_selectedTime.hour,_selectedTime.minute))}")),
